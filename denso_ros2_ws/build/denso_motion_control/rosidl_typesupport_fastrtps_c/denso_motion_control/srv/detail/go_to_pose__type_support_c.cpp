...
#include "denso_motion_control/srv/detail/go_to_pose__rosidl_typesupport_fastrtps_c.h"
...
using _GoToPose_Request__ros_msg_type = denso_motion_control__srv__GoToPose_Request;
...
size_t get_serialized_size_denso_motion_control__srv__GoToPose_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_Request__ros_msg_type * ros_message = static_cast<const _GoToPose_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GoToPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_denso_motion_control__srv__GoToPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_denso_motion_control
size_t max_serialized_size_denso_motion_control__srv__GoToPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = denso_motion_control__srv__GoToPose_Request;
    is_plain =
      (
...
static size_t _GoToPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_denso_motion_control__srv__GoToPose_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, GoToPose_Request)() {
...
using _GoToPose_Response__ros_msg_type = denso_motion_control__srv__GoToPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_denso_motion_control
size_t get_serialized_size_denso_motion_control__srv__GoToPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPose_Response__ros_msg_type * ros_message = static_cast<const _GoToPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_denso_motion_control__srv__GoToPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_denso_motion_control
size_t max_serialized_size_denso_motion_control__srv__GoToPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = denso_motion_control__srv__GoToPose_Response;
    is_plain =
      (
...
static size_t _GoToPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_denso_motion_control__srv__GoToPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, GoToPose_Response)() {
...
// already included above
// #include "denso_motion_control/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "denso_motion_control/srv/go_to_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, GoToPose)() {
