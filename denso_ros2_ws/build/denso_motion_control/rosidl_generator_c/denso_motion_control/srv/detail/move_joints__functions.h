...
#ifndef DENSO_MOTION_CONTROL__SRV__DETAIL__MOVE_JOINTS__FUNCTIONS_H_
#define DENSO_MOTION_CONTROL__SRV__DETAIL__MOVE_JOINTS__FUNCTIONS_H_
 ...
 * calls
 * denso_motion_control__srv__MoveJoints_Request__init().
...
/**
 * It calls
 * denso_motion_control__srv__MoveJoints_Request__fini()
 ...
 * denso_motion_control__srv__MoveJoints_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * denso_motion_control__srv__MoveJoints_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * denso_motion_control__srv__MoveJoints_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_denso_motion_control
...
/**
 * It calls
 * denso_motion_control__srv__MoveJoints_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_denso_motion_control
...
/**
 * It allocates the memory for the array and calls
 * denso_motion_control__srv__MoveJoints_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_denso_motion_control
...
/**
 * It calls
 * denso_motion_control__srv__MoveJoints_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DENSO_MOTION_CONTROL__SRV__DETAIL__MOVE_JOINTS__FUNCTIONS_H_
