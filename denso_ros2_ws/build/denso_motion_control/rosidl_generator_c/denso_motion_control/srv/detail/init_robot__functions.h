...
#ifndef DENSO_MOTION_CONTROL__SRV__DETAIL__INIT_ROBOT__FUNCTIONS_H_
#define DENSO_MOTION_CONTROL__SRV__DETAIL__INIT_ROBOT__FUNCTIONS_H_
...
/// Initialize srv/InitRobot message.
/**
...
/// Finalize srv/InitRobot message.
/**
...
/// Create srv/InitRobot message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * denso_motion_control__srv__InitRobot_Request__init().
...
/// Destroy srv/InitRobot message.
/**
 * It calls
 * denso_motion_control__srv__InitRobot_Request__fini()
...
/// Check for srv/InitRobot message equality.
/**
...
/// Initialize array of srv/InitRobot messages.
/**
...
/// Finalize array of srv/InitRobot messages.
/**
 * It calls
 * denso_motion_control__srv__InitRobot_Request__fini()
...
/// Create array of srv/InitRobot messages.
/**
 * It allocates the memory for the array and calls
 * denso_motion_control__srv__InitRobot_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/InitRobot messages.
/**
 * It calls
 * denso_motion_control__srv__InitRobot_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/InitRobot message array equality.
/**
...
/// Copy an array of srv/InitRobot messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * denso_motion_control__srv__InitRobot_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_denso_motion_control
...
/**
 * It calls
 * denso_motion_control__srv__InitRobot_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_denso_motion_control
...
/**
 * It allocates the memory for the array and calls
 * denso_motion_control__srv__InitRobot_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_denso_motion_control
...
/**
 * It calls
 * denso_motion_control__srv__InitRobot_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DENSO_MOTION_CONTROL__SRV__DETAIL__INIT_ROBOT__FUNCTIONS_H_
