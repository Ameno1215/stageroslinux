...
static const _InitRobot_Request_type_support_symbol_names_t _InitRobot_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, InitRobot_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, InitRobot_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, InitRobot_Request)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::InitRobot_Request_message_type_support_handle;
}
...
static const _InitRobot_Response_type_support_symbol_names_t _InitRobot_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, InitRobot_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, InitRobot_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, InitRobot_Response)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::InitRobot_Response_message_type_support_handle;
}
...
static const _InitRobot_type_support_symbol_names_t _InitRobot_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, InitRobot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, InitRobot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, InitRobot)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::InitRobot_service_type_support_handle;
}
