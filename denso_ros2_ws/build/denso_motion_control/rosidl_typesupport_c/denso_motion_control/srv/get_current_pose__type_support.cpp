...
static const _GetCurrentPose_Request_type_support_symbol_names_t _GetCurrentPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, GetCurrentPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, GetCurrentPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, GetCurrentPose_Request)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::GetCurrentPose_Request_message_type_support_handle;
}
...
static const _GetCurrentPose_Response_type_support_symbol_names_t _GetCurrentPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, GetCurrentPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, GetCurrentPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, GetCurrentPose_Response)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::GetCurrentPose_Response_message_type_support_handle;
}
...
static const _GetCurrentPose_type_support_symbol_names_t _GetCurrentPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, GetCurrentPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, GetCurrentPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, GetCurrentPose)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::GetCurrentPose_service_type_support_handle;
}
