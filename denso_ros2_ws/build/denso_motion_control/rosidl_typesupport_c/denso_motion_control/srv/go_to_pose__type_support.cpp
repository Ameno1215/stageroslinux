...
static const _GoToPose_Request_type_support_symbol_names_t _GoToPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, GoToPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, GoToPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, GoToPose_Request)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::GoToPose_Request_message_type_support_handle;
}
...
static const _GoToPose_Response_type_support_symbol_names_t _GoToPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, GoToPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, GoToPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, GoToPose_Response)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::GoToPose_Response_message_type_support_handle;
}
...
static const _GoToPose_type_support_symbol_names_t _GoToPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, GoToPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, GoToPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, GoToPose)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::GoToPose_service_type_support_handle;
}
