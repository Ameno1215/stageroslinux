...
static const _MoveJoints_Request_type_support_symbol_names_t _MoveJoints_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, MoveJoints_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, MoveJoints_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, MoveJoints_Request)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::MoveJoints_Request_message_type_support_handle;
}
...
static const _MoveJoints_Response_type_support_symbol_names_t _MoveJoints_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, MoveJoints_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, MoveJoints_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, MoveJoints_Response)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::MoveJoints_Response_message_type_support_handle;
}
...
static const _MoveJoints_type_support_symbol_names_t _MoveJoints_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_motion_control, srv, MoveJoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_motion_control, srv, MoveJoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, denso_motion_control, srv, MoveJoints)() {
  return &::denso_motion_control::srv::rosidl_typesupport_c::MoveJoints_service_type_support_handle;
}
