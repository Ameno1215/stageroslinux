...
bool denso_motion_control__srv__move_waypoints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("denso_motion_control.srv._move_waypoints.MoveWaypoints_Request", full_classname_dest, 62) == 0);
  }
  denso_motion_control__srv__MoveWaypoints_Request * ros_message = _ros_message;
  {  // waypoints
...
{
  /* NOTE(esteve): Call constructor of MoveWaypoints_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("denso_motion_control.srv._move_waypoints");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveWaypoints_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool denso_motion_control__srv__move_waypoints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("denso_motion_control.srv._move_waypoints.MoveWaypoints_Response", full_classname_dest, 63) == 0);
  }
  denso_motion_control__srv__MoveWaypoints_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of MoveWaypoints_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("denso_motion_control.srv._move_waypoints");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveWaypoints_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
